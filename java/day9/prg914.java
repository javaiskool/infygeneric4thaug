...
class B
{
	public void displayB(){System.out.println("welcome in B");}
}
class A extends B implements Inf1,Inf2 // implements keyword is used to inherit interface to the class
{
